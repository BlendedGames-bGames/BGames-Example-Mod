...
public class ModMessages {
    public static final Identifier BUTTON_BGAMES_INTERACT =new Identifier(BgamesLibrary.MOD_ID,"button_bgames_interact");
    public static final Identifier BUTTON_OPEN_SCREEN =new Identifier(BgamesLibrary.MOD_ID,"button_open_screen");
    public static final Identifier CREATE_AREA_PARTICLES =new Identifier(BgamesLibrary.MOD_ID,"area_particles");
